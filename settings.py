...
infection_chance = 0.2 # chance for an infected dot to infect a susceptible dot each frame
...
go_to_work_chance = 0*0.0001 # chance each frame that a dot decides to go "to work"
reduced_go_to_work_chance = 0*0.00001 # chance after reduction in how many goes to work
